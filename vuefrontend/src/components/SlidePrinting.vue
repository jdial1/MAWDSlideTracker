...
export default {
  ...
  methods: {
    ...
    printSlides() {
      axios
        .post(store.getters.getApiUrl + "/printslides", {
          action: "PrintSlides",
    ...
    updateSlideToPrintValue(strSlideID, blChecked) {
      ...
      axios
        .post(store.getters.getApiUrl + "/updateslidetoprint", {
    ...
    GetPartBlockCurrentAndTotals() {
      ...
      axios
        .post(store.getters.getApiUrl + "/getpartblockcurrentandtotals", {
          blockID: this.blockID,
          curRoute: this.currentRouteName,
        })
        .then((apidata) => {
    ...
    manuallyLoadBlockID() {
      this.blockID =
        "HBLK" +
        this.manualcaseprefix +
        this.manualcasetwodigityear +
        "-" +
        this.manualcasenumber +
        "_" +
        this.manualpart +
        "_" +
        this.manualblock;
